...
export function TopBar({ title, actions }: Props) {
  ...
  return (
    <header className="top_bar m3-elevation-1">
      <div className="top_bar_left">
        <button className="top_bar_menu" onClick={toggleSidebar} aria-label="Open menu">
      ...
      <div className="top_bar_right">
        {actions && <div className="top_bar_actions">{actions}</div>}

        <div className="top_bar_clock">
          <span className="top_bar_time">{timeLabel}</span>
          <span className="top_bar_date">{dateLabel}</span>
        </div>

        <label className="swap swap-rotate top_bar_theme">
